...
Route::group(["namespace"=>"Admin","prefix"=>"admin","middleware"=>["auth"]], function(){
    ...
    Route::post('/loan-interest-master-create',[App\Http\Controllers\admin\loaninterestmastercontroller::class,'loaninterestmastercreate']);
    Route::get('/loan-interest-master-edit-view/{id}',[App\Http\Controllers\admin\loaninterestmastercontroller::class,'loaninterestmastereditview']);
    Route::POST('/loan-interest-master-edit/{id}',[App\Http\Controllers\admin\loaninterestmastercontroller::class,'loaninterestmasteredit']);        
    Route::get('/loan-interest-master-delete/{id}',[App\Http\Controllers\admin\loaninterestmastercontroller::class,'loaninterestmasterdelete']);
    Route::post('/loan-create',[App\Http\Controllers\admin\loanmastercontroller::class,'loancreate']);
    Route::get('/loan-delete/{id}',[App\Http\Controllers\admin\loanmastercontroller::class,'loandelete']);
    ...
    Route::post('/loan-payment-done',[App\Http\Controllers\admin\loanpaymentcontroller::class,'loanpaymentdone']);
    ...
    Route::get('/member-modification',[App\Http\Controllers\admin\membermodificationcontroller::class,'membermodification']);
    Route::get('/loan-entry-modification',[App\Http\Controllers\admin\loanentrymodificationcontroller::class,'loanentrymodification']);
    Route::post('/loanentry',[App\Http\Controllers\admin\loanentrymodificationcontroller::class,'loanentry']);
    Route::get('/gold-loan-modification',[App\Http\Controllers\admin\goldloanmodificationcontroller::class,'goldloanmodification']);
    Route::get('/cheque-clear-section',[App\Http\Controllers\admin\chequeclearsectioncontroller::class,'chequeclearsection']);
