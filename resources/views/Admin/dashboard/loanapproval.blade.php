...
@section('title', 'Admin/Loan Approval')
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control form-select-lg mb-3 rounded" id="loanapproval" name="loanapproval"
                                aria-label=".form-select-lg example">                                
                                <option selected class="text-danger">Please Select Applicant Name</option>                                
                                    @foreach($data as $c)                                 
                                        <option value="{{ $c->cust_id }}" href="{{ url('admin/customer/'.$c->cust_id)}}">                                       
                                            {{ $c->cust_fname}} - {{ date('d,M-Y Ha:s',strtotime($c->created_at))}}                                                             
                                        </option>
                                     @endforeach
                            </select>                            
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="apname">Loan ID</label>
                                <input type="text" class="form-control" placeholder="Enter Applicant Name" value="" name="apname">
                        </div>
                        <div class="col">
            ...
            <div class="container shadow-lg p-3 mb-5 bg-body rounded">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="date" class="form-control" placeholder="Enter Applicant Name" name="apname" value="">
                    </div>
                    <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <form action="{{ url('admin/loan-payment-done') }}" method="POST" enctype='multipart/form-data'>
                        @csrf
                        <button class="form-control bg-success" onclick="return confirm('Are You Want To Continue Payment... ?')"><i class="fas fa-thumbs-up"></i> Approved It</button>                        
                    </form>
                </div>
                <div class="col">
                    <input class="form-control bg-danger" type="button" onclick="return confirm('Are You Want Revert This Approval... ?')" name="revert" value="*Don't Approved">
                </div>
            </div>
        </div>
    </div>
