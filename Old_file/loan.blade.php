...
<div class="row">
    <div class="col">
        <div class="container">
            <h1 class="bg-secondary rounded text-center" style="font-size:25px">Details</h1>
    ...
    <div class="col">
        ...
        <div class="container shadow-lg p-3 mb-5 bg-body rounded">
            ...
            <div class="row">
                <div class="col">Cheque Date*</div>
                <div class="col"><input type="date" class="form-control"></div>
                <div class="col">Bank A/C</div>
        ...
        <div class="col">
            <div class="row">
                <div class="col">
                    <form action="{{ url('admin/loan/loanpayment') }}" method="POST" enctype='multipart/form-data'>
                        @csrf
                        <button class="form-control bg-success" onclick="return confirm('Are You Want To Continue Payment... ?')"><i class="fas fa-thumbs-up"></i> Pay</button>                        
                    </form>
                </div>
                <div class="col">
                    <input class="form-control bg-danger" type="button" onclick="return confirm('Are You Want Revert This Approval... ?')" name="revert" value="*Revert">
                </div>
            </div>
        </div>
    </div>
